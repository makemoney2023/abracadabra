...
4. **Fill the capture gaps.** Schema seeded `/scan/[token]` report (the sales docs already ask for it), the LLM Leverage lesson body, and a CDA product page (private repo; needs demo mode).

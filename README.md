...
The plan for the chapter that leads into Answer Engine Optimization — marketing, applications, machine learning with PIRX, systems of record, and commerce, in that order — is [docs/anything-digital-lead-in-plan.md](docs/anything-digital-lead-in-plan.md). It is not on the page yet.
